...
<body class="body-container">
    <header id="Header-Container" class="header-container">
        ...
        <svg version="1.1" class="header-logo" id="Panda" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <ellipse transform="matrix(0.4131 -0.9107 0.9107 0.4131 -62.0769 161.6891)" class="st2" cx="94.4" cy="129" rx="44.4" ry="18.8" />
            <ellipse transform="matrix(0.8921 -0.4518 0.4518 0.8921 -38.4583 96.9566)" class="st2" cx="183.8" cy="129" rx="18.8" ry="44.4" />
    ...
    <main id="Main-Container" class="main-container off">
        <article class="Menu">
            ...
            <section id="globe" class="globe">
                ...
                <div id="clouds2" class="clouds clouds2"></div>
                <nav>
                    <ul>
        ...
        <article class="Main-Content">
            ...
            <section id="Home" class="Home Home-Content off">
                ...
                <div id="Home-Game" class="Home-Game">
                    <div class="Table">
                        <div class="Play">
                            <h2 class="TextPlay">Play</h2>
                            <h2 class="TextPlay off">You are the best!</h2>
                        </div>
                        <div class="CardsStart Cards1 off"></div>
                        ...
                        <div class="Cards Cards3 off"></div>
                        <div class="Cards Cards3 off"></div>
                        <div class="CardsEnd Cards3 off"></div>
                    </div>
                </div>
            </section>
            <section id="CV" class="CV CV-Content off">
                <div class="CV-Intro">
                    <div class="CV-Photo">
            ...
            <section id="Contacts" class="Contacts Contacts-Content off">
