...
<body class="HomeBG">
    <header>
        <section class="Logo">
            <div class="HeadTriangle"></div>
            <h1 class="Nick">cookavsky</h1>
        </section>
        <nav>
            <ul>
                <li>
    ...
    <main>
        <article class="Home">
            <div class="Table off">
                ...
                <div class="CardsStart Cards1 off">
                    <div class="halfTable"></div>
                    <p class="Text">Start</p>
                </div>
                <div class="Cards Cards1 off"></div>
                <div class="Cards Cards1 off"></div>
        ...
        <article class="CV off">
            <div class="CVChange">
                <div class="Up"></div>
                <div id="CVIntro" class="dotActiv"></div>
                <div id="CVHome" class="dot"></div>
                <div id="CVSchool" class="dot"></div>
                <div id="CVWork" class="dot"></div>
                <div class="Bottom"></div>
            </div>
            <div class="CVIntro">
                <div class="CVIntroImg"></div>
                <div class="CVText">
            ...
            <div class="CVHome off">
                <div class="CVHomeImg CVHomeImg1">
                    <div id="H1" class="MiniDotActiv"></div>
                    <div id="H2" class="MiniDot"></div>
                </div>
                <div class="CVText">
            ...
            <div class="CVSchool off">
                <div class="CVSchoolImg CVSchoolImg1">
                    <div id="S1" class="MiniDotActiv"></div>
                    <div id="S2" class="MiniDot"></div>
                </div>
                <div class="CVText">
            ...
            <div class="CVWork off">
                <div class="CVWorkImg CVWorkImg1">
                    <div id="W1" class="MiniDotActiv"></div>
                    <div id="W2" class="MiniDot"></div>
                    <div id="W3" class="MiniDot"></div>
                </div>
                <div class="CVText">
            ...
            <div class="Shelf">
                <a href="https://fifa.cookavsky.com" target="_blank">
                    <div class="book b-1">
                        ...
                        <div id="Project1" class="book-pos right"></div>
                ...
                <a href="https://schools.cookavsky.com" target="_blank">
                    <div class="book b-2">
                        ...
                        <div id="Project2" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
                <a href="https://weeklyone.cookavsky.com" target="_blank">
                    <div class="book b-3">
                        ...
                        <div id="Project3" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
                <a href="https://weeklytwo.cookavsky.com" target="_blank">
                    <div class="book b-4">
                        ...
                        <div id="Project4" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
                <a href="https://weeklythree.cookavsky.com" target="_blank">
                    <div class="book b-5">
                        ...
                        <div id="Project5" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
                <a href="https://weeklyfour.cookavsky.com" target="_blank">
                    <div class="book b-6">
                        ...
                        <div id="Project6" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
                <a href="https://weeklyeleven.cookavsky.com" target="_blank">
                    <div class="book b-7">
                        ...
                        <div id="Project7" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
                <a href="https://angulartable.cookavsky.com" target="_blank">
                    <div class="book b-8">
                        ...
                        <div id="Project8" class="book-pos right"></div>
                        <div class="book-pos top"></div>
                    </div>
                </a>
            </div>
        </article>
        <article class="Contacts off">
            <form class="Mail"  action="message.php" method="post">
                <input class="form Name"  type='text' name='name' placeholder="Your name">
            ...
            <div class="Data off">
                <div class="Facebook">
                    ...
                    <h3>Marcin Panda Kukawski</h3>
                </div>
                <div class="Github">
                    <a href="https://github.com/cookavsky" target="_blank">
                        <img src="img/github.png">
                    </a>
                    <h3>cookavsky</h3>
                </div>
                <div class="Linkedin">
                    <a href="https://www.linkedin.com/in/cookavsky" target="_blank">
                        <img src="img/linkedin.png">
                    </a>
                    <h3>Marcin Kukawski</h3>
                </div>
            </div>
        </article>
    </main>
